...
public class PostController {
    ...
    public ResponseEntity<PostDto> createPost(@RequestBody PostDto postDto,@PathVariable Integer userId, 
                                                            @PathVariable Integer categoryId) throws UserNotFoundException{
    ...
    public ResponseEntity<List<PostDto>> searchPostByTitles(@PathVariable("keywords") String keywords){
